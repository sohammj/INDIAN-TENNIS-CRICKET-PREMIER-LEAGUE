        ...
        <div className="hidden items-center gap-3 md:flex">
          {!user ? (
            <>
              <Link
                href="/auth/sign-in"
                className="ui-font border border-[var(--flame)] px-4 py-2 text-sm font-bold uppercase tracking-[0.22em] text-[var(--flame)] transition hover:bg-[var(--flame)] hover:text-white"
              >
                Sign In
              </Link>
              <Link
                href="/auth/register"
                className="ui-font bg-[var(--flame)] px-4 py-2 text-sm font-bold uppercase tracking-[0.22em] text-white transition hover:bg-[var(--flame-soft)]"
              >
                Register - ₹999
              </Link>
            </>
